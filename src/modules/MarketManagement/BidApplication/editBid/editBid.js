$(function () {
    ...
    function getBidAddlyInfo() {
        $http({
            ...
            success: function (r) {
                ...
                $(".projectPerson").html(a.projectPerson) //项目发起人 // 回显地区
                if (a.regionList) {
    ...
    function getBidDocAddlyInfo() {
        $http({
            ...
            success: function (r) {
                if (!r.data.obj) return false
                var a = r.data.obj
                $(".purchaseAmount").val((a.purchaseAmount ? a.purchaseAmount : '0')) //金额
    ...
    var postData = {
        ...
        // docId  :"标书购买申请ID"           //标书购买申请ID  数字           
    }
    //标书购买申请添加
    function editBidPost(status) {
        var postObj = {
            remark: $(".remark").val(),
            status: status,
            docId: DocId//标书购买申请ID
        ...
        $http({
            url: '/gct-web/bidDocApply/getBidDocApplyUpdate',
            data: postObj,
            success: function (r) {
